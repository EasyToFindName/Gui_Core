...
TextLabel::TextLabel(Container* parent, const std::string& fontPath,
...
void TextLabel::setText(const std::string& text) { m_text.setString(text); }
...
void TextLabel::setColor(const sf::Color& c) { m_text.setFillColor(c); }
