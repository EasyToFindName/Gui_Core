...
ResourceCacher* Gui::resources() { return &m_resourceCache; }

void Gui::draw() { m_window.draw(*this); }
...
void Gui::captureEvent(sf::Event e) {
  if (e.type == sf::Event::MouseMoved) {
    ...
    if (m_selectedActiveItem != nullptr) {
      m_selectedActiveItem->onPressed(e.mouseButton.button, e.mouseButton.x,
                                      e.mouseButton.y);
    ...
    if (m_selectedActiveItem != nullptr) {
      m_selectedActiveItem->onReleased(e.mouseButton.button, e.mouseButton.x,
                                       e.mouseButton.y);
